package budget_yaroslav;

import budget_yaroslav.dao.BudgetImpl;
import budget_yaroslav.model.Menu;
import budget_yaroslav.model.Product;
...
public class BudgetAppl {
    private static final String SAVE_PATH = "./dest/family-budget.csv";
    public static void main(String[] args) throws IOException {
        ...
        BufferedReader br=new BufferedReader(new FileReader("./dest/products.csv"));
